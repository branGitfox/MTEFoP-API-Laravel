...
Route::delete('/deleteMessages/{id}', [SupportController::class, 'deleteMessages'])->middleware("auth:sanctum");
Route::delete('/messages/deleteAll', [SupportController::class, 'deleteAllMessages'])->middleware("auth:sanctum");
